...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Upgrade Now", "Zum Upgrade Now anklicken"),
        ...
        ("config_acc", "Um Ihren Desktop aus der Ferne zu steuern, müssen Sie HopToDesk \"Zugangs\" Rechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren Desktop zugreifen zu können, müssen Sie HopToDesk \"Bildschirm-Aufnahme\" Berechtigungen erteilen."),
        ...
        ("A new update is available.", "Ihre Installation ist eine niedrigere Version."),
