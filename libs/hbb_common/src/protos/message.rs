...
impl PeerInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "mac_address",
            |m: &PeerInfo| { &m.mac_address },
            |m: &mut PeerInfo| { &mut m.mac_address },
        ));
...
impl ::protobuf::Message for PeerInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ::protobuf::rt::read_singular_message_into_field(wire_type, is, &mut self.features)?;
                },
                10 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.conn_id != 0 {
            my_size += ::protobuf::rt::value_size(8, self.conn_id, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if !self.mac_address.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.mac_address);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.mac_address.is_empty() {
            os.write_string(10, &self.mac_address)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl FileAction {
    ...
    pub fn get_send_confirm(&self) -> &FileTransferSendConfirmRequest {
        match self.union {
            ::std::option::Option::Some(file_action::Union::send_confirm(ref v)) => v,
    ...
    pub fn has_send_confirm(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(file_action::Union::send_confirm(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_send_confirm(&mut self, v: FileTransferSendConfirmRequest) {
        self.union = ::std::option::Option::Some(file_action::Union::send_confirm(v))
    }

    // Mutable pointer to the field.
    pub fn mut_send_confirm(&mut self) -> &mut FileTransferSendConfirmRequest {
        if let ::std::option::Option::Some(file_action::Union::send_confirm(_)) = self.union {
        } else {
            self.union = ::std::option::Option::Some(file_action::Union::send_confirm(FileTransferSendConfirmRequest::new()));
        }
        match self.union {
            ::std::option::Option::Some(file_action::Union::send_confirm(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_send_confirm(&mut self) -> FileTransferSendConfirmRequest {
        if self.has_send_confirm() {
            match self.union.take() {
                ::std::option::Option::Some(file_action::Union::send_confirm(v)) => v,
                _ => panic!(),
            }
        } else {
...
impl ::protobuf::Message for FileAction {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(file_action::Union::send_confirm(ref v)) = self.union {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ...
                    self.union = ::std::option::Option::Some(file_action::Union::send_confirm(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                ...
                &file_action::Union::send_confirm(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
...
pub mod file_action {
    ...
    pub enum Union {
        ...
        send_confirm(super::FileTransferSendConfirmRequest),
    }
...
impl FileResponse {
    ...
    pub fn get_digest(&self) -> &FileTransferDigest {
        match self.union {
...
impl ::protobuf::Message for FileResponse {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(file_response::Union::digest(ref v)) = self.union {
            if !v.is_initialized() {
                return false;
            }
        }
...
impl ::protobuf::Message for FileTransferDigest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.file_size != 0 {
            my_size += ::protobuf::rt::value_size(4, self.file_size, ::protobuf::wire_format::WireTypeVarint);
        }
...
impl ::protobuf::Clear for FileTransferDigest {
    fn clear(&mut self) {
        self.id = 0;
        self.file_num = 0;
...
impl ::std::fmt::Debug for FileTransferDigest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
impl ::protobuf::Message for FileTransferBlock {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.blk_id != 0 {
            my_size += ::protobuf::rt::value_size(5, self.blk_id, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
...
impl ::protobuf::Message for FileTransferSendRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.file_num != 0 {
            my_size += ::protobuf::rt::value_size(4, self.file_num, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
...
impl FileTransferSendConfirmRequest {
    ...
    pub fn get_offset_blk(&self) -> u32 {
        match self.union {
            ::std::option::Option::Some(file_transfer_send_confirm_request::Union::offset_blk(v)) => v,
            _ => 0,
        }
    }
    ...
    pub fn has_offset_blk(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(file_transfer_send_confirm_request::Union::offset_blk(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_offset_blk(&mut self, v: u32) {
        self.union = ::std::option::Option::Some(file_transfer_send_confirm_request::Union::offset_blk(v))
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_copy_has_get_set_simpler_accessors::<_, _>(
            ...
            FileTransferSendConfirmRequest::get_skip,
            FileTransferSendConfirmRequest::set_skip,
        ));
        fields.push(::protobuf::reflect::rt::v2::make_oneof_copy_has_get_set_simpler_accessors::<_, _>(
            "offset_blk",
            FileTransferSendConfirmRequest::has_offset_blk,
            FileTransferSendConfirmRequest::get_offset_blk,
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ...
                    self.union = ::std::option::Option::Some(file_transfer_send_confirm_request::Union::offset_blk(is.read_uint32()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                ...
                &file_transfer_send_confirm_request::Union::offset_blk(v) => {
                    my_size += ::protobuf::rt::value_size(4, v, ::protobuf::wire_format::WireTypeVarint);
                },
            };
        }
...
impl ::protobuf::Clear for FileTransferSendConfirmRequest {
    fn clear(&mut self) {
        self.id = 0;
        self.file_num = 0;
        self.union = ::std::option::Option::None;
...
impl ::std::fmt::Debug for FileTransferSendConfirmRequest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
impl BackNotification {
    ...
    pub fn get_privacy_mode_state(&self) -> back_notification::PrivacyModeState {
        match self.union {
            ::std::option::Option::Some(back_notification::Union::privacy_mode_state(v)) => ::protobuf::ProtobufEnumOrUnknown::enum_value_or_default(&v),
            _ => back_notification::PrivacyModeState::StateUnknown,
        }
    }
    ...
    pub fn has_privacy_mode_state(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(back_notification::Union::privacy_mode_state(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_privacy_mode_state(&mut self, v: back_notification::PrivacyModeState) {
        self.union = ::std::option::Option::Some(back_notification::Union::privacy_mode_state(::protobuf::ProtobufEnumOrUnknown::new(v)))
    }

    // .hbb.BackNotification.BlockInputState block_input_state = 2;

    pub fn get_block_input_state(&self) -> back_notification::BlockInputState {
        match self.union {
            ::std::option::Option::Some(back_notification::Union::block_input_state(v)) => ::protobuf::ProtobufEnumOrUnknown::enum_value_or_default(&v),
            _ => back_notification::BlockInputState::StateUnknown,
        }
    }
    ...
    pub fn has_block_input_state(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(back_notification::Union::block_input_state(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_block_input_state(&mut self, v: back_notification::BlockInputState) {
        self.union = ::std::option::Option::Some(back_notification::Union::block_input_state(::protobuf::ProtobufEnumOrUnknown::new(v)))
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_copy_has_get_set_simpler_accessors::<_, _>(
            "privacy_mode_state",
            BackNotification::has_privacy_mode_state,
            BackNotification::get_privacy_mode_state,
            BackNotification::set_privacy_mode_state,
        ));
        fields.push(::protobuf::reflect::rt::v2::make_oneof_copy_has_get_set_simpler_accessors::<_, _>(
            "block_input_state",
            BackNotification::has_block_input_state,
            BackNotification::get_block_input_state,
            BackNotification::set_block_input_state,
        ));
...
impl ::protobuf::Message for BackNotification {
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.union = ::std::option::Option::Some(back_notification::Union::privacy_mode_state(is.read_enum_or_unknown()?));
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.union = ::std::option::Option::Some(back_notification::Union::block_input_state(is.read_enum_or_unknown()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                &back_notification::Union::privacy_mode_state(v) => {
                    my_size += ::protobuf::rt::enum_or_unknown_size(1, v);
                },
                &back_notification::Union::block_input_state(v) => {
    ...
    fn descriptor_static() -> ::protobuf::reflect::MessageDescriptor {
        ::protobuf::reflect::MessageDescriptor::new_generated_2(file_descriptor(), 54)
    }
...
impl ::protobuf::Clear for BackNotification {
    fn clear(&mut self) {
        self.union = ::std::option::Option::None;
        self.union = ::std::option::Option::None;
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for BackNotification {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
pub mod back_notification {
    ...
    #[derive(Clone,PartialEq,Debug)]
    pub enum Union {
        privacy_mode_state(::protobuf::ProtobufEnumOrUnknown<PrivacyModeState>),
        block_input_state(::protobuf::ProtobufEnumOrUnknown<BlockInputState>),
    }
    ...
    impl ::protobuf::ProtobufEnum for BlockInputState {
        fn value(&self) -> i32 {
            *self as i32
        }
        ...
        fn from_i32(value: i32) -> ::std::option::Option<BlockInputState> {
            match value {
                1 => ::std::option::Option::Some(BlockInputState::StateUnknown),
                2 => ::std::option::Option::Some(BlockInputState::OnSucceeded),
                3 => ::std::option::Option::Some(BlockInputState::OnFailed),
                4 => ::std::option::Option::Some(BlockInputState::OffSucceeded),
                5 => ::std::option::Option::Some(BlockInputState::OffFailed),
                _ => ::std::option::Option::None
            }
        }

        fn values() -> &'static [Self] {
            static values: &'static [BlockInputState] = &[
                BlockInputState::StateUnknown,
                BlockInputState::OnSucceeded,
                BlockInputState::OnFailed,
                BlockInputState::OffSucceeded,
                BlockInputState::OffFailed,
            ];
            values
        }
    ...
    impl ::protobuf::reflect::ProtobufValue for BlockInputState {
        type RuntimeType = ::protobuf::reflect::runtime_types::RuntimeTypeEnum<Self>;
    }

    impl BlockInputState {
        pub(in super) fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
            ::protobuf::reflect::GeneratedEnumDescriptorData::new_2::<BlockInputState>("BackNotification.BlockInputState", 5)
        }
    }
    ...
    impl ::protobuf::ProtobufEnum for PrivacyModeState {
        fn value(&self) -> i32 {
            *self as i32
        }
        ...
        fn from_i32(value: i32) -> ::std::option::Option<PrivacyModeState> {
            match value {
                1 => ::std::option::Option::Some(PrivacyModeState::StateUnknown),
                2 => ::std::option::Option::Some(PrivacyModeState::OnByOther),
                3 => ::std::option::Option::Some(PrivacyModeState::NotSupported),
                4 => ::std::option::Option::Some(PrivacyModeState::OnSucceeded),
                5 => ::std::option::Option::Some(PrivacyModeState::OnFailedDenied),
                6 => ::std::option::Option::Some(PrivacyModeState::OnFailedPlugin),
                7 => ::std::option::Option::Some(PrivacyModeState::OnFailed),
                8 => ::std::option::Option::Some(PrivacyModeState::OffSucceeded),
                9 => ::std::option::Option::Some(PrivacyModeState::OffByPeer),
                10 => ::std::option::Option::Some(PrivacyModeState::OffFailed),
                11 => ::std::option::Option::Some(PrivacyModeState::OffUnknown),
                _ => ::std::option::Option::None
            }
        }

        fn values() -> &'static [Self] {
            static values: &'static [PrivacyModeState] = &[
                PrivacyModeState::StateUnknown,
                PrivacyModeState::OnByOther,
                PrivacyModeState::NotSupported,
                PrivacyModeState::OnSucceeded,
                PrivacyModeState::OnFailedDenied,
                PrivacyModeState::OnFailedPlugin,
                PrivacyModeState::OnFailed,
                PrivacyModeState::OffSucceeded,
                PrivacyModeState::OffByPeer,
                PrivacyModeState::OffFailed,
    ...
    impl ::protobuf::reflect::ProtobufValue for PrivacyModeState {
        type RuntimeType = ::protobuf::reflect::runtime_types::RuntimeTypeEnum<Self>;
    }

    impl PrivacyModeState {
        pub(in super) fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
            ::protobuf::reflect::GeneratedEnumDescriptorData::new_2::<PrivacyModeState>("BackNotification.PrivacyModeState", 6)
        }
    }
}
...
impl Misc {
    ...
    pub fn get_back_notification(&self) -> &BackNotification {
        match self.union {
            ::std::option::Option::Some(misc::Union::back_notification(ref v)) => v,
    ...
    pub fn has_back_notification(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(misc::Union::back_notification(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_back_notification(&mut self, v: BackNotification) {
        self.union = ::std::option::Option::Some(misc::Union::back_notification(v))
    }

    // Mutable pointer to the field.
    pub fn mut_back_notification(&mut self) -> &mut BackNotification {
        if let ::std::option::Option::Some(misc::Union::back_notification(_)) = self.union {
        } else {
            self.union = ::std::option::Option::Some(misc::Union::back_notification(BackNotification::new()));
        }
        match self.union {
            ::std::option::Option::Some(misc::Union::back_notification(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_back_notification(&mut self) -> BackNotification {
        if self.has_back_notification() {
            match self.union.take() {
                ::std::option::Option::Some(misc::Union::back_notification(v)) => v,
                _ => panic!(),
            }
        } else {
            BackNotification::new()
...
impl ::protobuf::Message for Misc {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(misc::Union::back_notification(ref v)) = self.union {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                13 => {
                    ...
                    self.union = ::std::option::Option::Some(misc::Union::back_notification(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                ...
                &misc::Union::back_notification(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
    ...
    fn descriptor_static() -> ::protobuf::reflect::MessageDescriptor {
        ::protobuf::reflect::MessageDescriptor::new_generated_2(file_descriptor(), 55)
    }
...
pub mod misc {
    ...
    pub enum Union {
        ...
        refresh_video(bool),
        video_received(bool),
        back_notification(super::BackNotification),
    }
...
impl ::protobuf::Message for Message {
    ...
    fn descriptor_static() -> ::protobuf::reflect::MessageDescriptor {
        ::protobuf::reflect::MessageDescriptor::new_generated_2(file_descriptor(), 56)
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\n\x06stride\x18\x02\x20\x01(\x05R\x06strideB\0:\0\"\x9c\x01\n\nVide\
    oFrame\x12!\n\x04vp9s\x18\x06\x20\x01(\x0b2\t.hbb.VP9sH\0R\x04vp9sB\0\
    \x12\x1e\n\x03rgb\x18\x07\x20\x01(\x0b2\x08.hbb.RGBH\0R\x03rgbB\0\x12\
    \x1e\n\x03yuv\x18\x08\x20\x01(\x0b2\x08.hbb.YUVH\0R\x03yuvB\0\x12\x1e\n\
    \ttimestamp\x18\t\x20\x01(\x03R\ttimestampB\0B\t\n\x05union\x12\0:\0\",\
    \n\x04IdPk\x12\x10\n\x02id\x18\x01\x20\x01(\tR\x02idB\0\x12\x10\n\x02pk\
    \x18\x02\x20\x01(\x0cR\x02pkB\0:\0\"\x91\x01\n\x0bDisplayInfo\x12\x0e\n\
    ...
    \x20\x01(\tR\x04nameB\0\x12\x18\n\x06online\x18\x06\x20\x01(\x08R\x06onl\
    ineB\0:\0\";\n\x0bPortForward\x12\x14\n\x04host\x18\x01\x20\x01(\tR\x04h\
    ostB\0\x12\x14\n\x04port\x18\x02\x20\x01(\x05R\x04portB\0:\0\"G\n\x0cFil\
    eTransfer\x12\x12\n\x03dir\x18\x01\x20\x01(\tR\x03dirB\0\x12!\n\x0bshow_\
    hidden\x18\x02\x20\x01(\x08R\nshowHiddenB\0:\0\"\xdc\x02\n\x0cLoginReque\
    st\x12\x1c\n\x08username\x18\x01\x20\x01(\tR\x08usernameB\0\x12\x1c\n\
    \x08password\x18\x02\x20\x01(\x0cR\x08passwordB\0\x12\x15\n\x05my_id\x18\
    \x04\x20\x01(\tR\x04myIdB\0\x12\x19\n\x07my_name\x18\x05\x20\x01(\tR\x06\
    myNameB\0\x12,\n\x06option\x18\x06\x20\x01(\x0b2\x12.hbb.OptionMessageR\
    \x06optionB\0\x12:\n\rfile_transfer\x18\x07\x20\x01(\x0b2\x11.hbb.FileTr\
    ansferH\0R\x0cfileTransferB\0\x127\n\x0cport_forward\x18\x08\x20\x01(\
    \x0b2\x10.hbb.PortForwardH\0R\x0bportForwardB\0\x12.\n\x12video_ack_requ\
    ired\x18\t\x20\x01(\x08R\x10videoAckRequiredB\0B\t\n\x05union\x12\0:\0\"\
    %\n\x0bChatMessage\x12\x14\n\x04text\x18\x01\x20\x01(\tR\x04textB\0:\0\"\
    1\n\x08Features\x12#\n\x0cprivacy_mode\x18\x01\x20\x01(\x08R\x0bprivacyM\
    ...
    n\x18\x07\x20\x01(\tR\x07versionB\0\x12\x19\n\x07conn_id\x18\x08\x20\x01\
    (\x05R\x06connIdB\0\x12+\n\x08features\x18\t\x20\x01(\x0b2\r.hbb.Feature\
    sR\x08featuresB\0\x12!\n\x0bmac_address\x18\n\x20\x01(\tR\nmacAddressB\0\
    :\0\"f\n\rLoginResponse\x12\x18\n\x05error\x18\x01\x20\x01(\tH\0R\x05err\
    orB\0\x12.\n\tpeer_info\x18\x02\x20\x01(\x0b2\r.hbb.PeerInfoH\0R\x08peer\
    InfoB\0B\t\n\x05union\x12\0:\0\"u\n\nMouseEvent\x12\x14\n\x04mask\x18\
    \x01\x20\x01(\x05R\x04maskB\0\x12\x0e\n\x01x\x18\x02\x20\x01(\x11R\x01xB\
    \0\x12\x0e\n\x01y\x18\x03\x20\x01(\x11R\x01yB\0\x12/\n\tmodifiers\x18\
    \x04\x20\x03(\x0e2\x0f.hbb.ControlKeyR\tmodifiersB\0:\0\"\xf6\x01\n\x08K\
    eyEvent\x12\x14\n\x04down\x18\x01\x20\x01(\x08R\x04downB\0\x12\x16\n\x05\
    press\x18\x02\x20\x01(\x08R\x05pressB\0\x124\n\x0bcontrol_key\x18\x03\
    \x20\x01(\x0e2\x0f.hbb.ControlKeyH\0R\ncontrolKeyB\0\x12\x14\n\x03chr\
    \x18\x04\x20\x01(\rH\0R\x03chrB\0\x12\x1c\n\x07unicode\x18\x05\x20\x01(\
    \rH\0R\x07unicodeB\0\x12\x14\n\x03seq\x18\x06\x20\x01(\tH\0R\x03seqB\0\
    \x12/\n\tmodifiers\x18\x08\x20\x03(\x0e2\x0f.hbb.ControlKeyR\tmodifiersB\
    \0B\t\n\x05union\x12\0:\0\"\x98\x01\n\nCursorData\x12\x10\n\x02id\x18\
    \x01\x20\x01(\x04R\x02idB\0\x12\x14\n\x04hotx\x18\x02\x20\x01(\x11R\x04h\
    otxB\0\x12\x14\n\x04hoty\x18\x03\x20\x01(\x11R\x04hotyB\0\x12\x16\n\x05w\
    idth\x18\x04\x20\x01(\x05R\x05widthB\0\x12\x18\n\x06height\x18\x05\x20\
    \x01(\x05R\x06heightB\0\x12\x18\n\x06colors\x18\x06\x20\x01(\x0cR\x06col\
    ...
    \x18\x02\x20\x01(\tR\tchallengeB\0:\0\"G\n\tClipboard\x12\x1c\n\x08compr\
    ess\x18\x01\x20\x01(\x08R\x08compressB\0\x12\x1a\n\x07content\x18\x02\
    \x20\x01(\x0cR\x07contentB\0:\0\"\xaf\x01\n\tFileEntry\x12.\n\nentry_typ\
    e\x18\x01\x20\x01(\x0e2\r.hbb.FileTypeR\tentryTypeB\0\x12\x14\n\x04name\
    \x18\x02\x20\x01(\tR\x04nameB\0\x12\x1d\n\tis_hidden\x18\x03\x20\x01(\
    \x08R\x08isHiddenB\0\x12\x14\n\x04size\x18\x04\x20\x01(\x04R\x04sizeB\0\
    \x12%\n\rmodified_time\x18\x05\x20\x01(\x04R\x0cmodifiedTimeB\0:\0\"e\n\
    ...
    \x03(\x0b2\x0e.hbb.FileEntryR\x07entriesB\0:\0\"J\n\x07ReadDir\x12\x14\n\
    \x04path\x18\x01\x20\x01(\tR\x04pathB\0\x12'\n\x0einclude_hidden\x18\x02\
    \x20\x01(\x08R\rincludeHiddenB\0:\0\"a\n\x0cReadAllFiles\x12\x10\n\x02id\
    \x18\x01\x20\x01(\x05R\x02idB\0\x12\x14\n\x04path\x18\x02\x20\x01(\tR\
    \x04pathB\0\x12'\n\x0einclude_hidden\x18\x03\x20\x01(\x08R\rincludeHidde\
    nB\0:\0\"\x91\x04\n\nFileAction\x12+\n\x08read_dir\x18\x01\x20\x01(\x0b2\
    \x0c.hbb.ReadDirH\0R\x07readDirB\0\x124\n\x04send\x18\x02\x20\x01(\x0b2\
    \x1c.hbb.FileTransferSendRequestH\0R\x04sendB\0\x12=\n\x07receive\x18\
    \x03\x20\x01(\x0b2\x1f.hbb.FileTransferReceiveRequestH\0R\x07receiveB\0\
    \x12.\n\x06create\x18\x04\x20\x01(\x0b2\x12.hbb.FileDirCreateH\0R\x06cre\
    ateB\0\x125\n\nremove_dir\x18\x05\x20\x01(\x0b2\x12.hbb.FileRemoveDirH\0\
    R\tremoveDirB\0\x128\n\x0bremove_file\x18\x06\x20\x01(\x0b2\x13.hbb.File\
    RemoveFileH\0R\nremoveFileB\0\x122\n\tall_files\x18\x07\x20\x01(\x0b2\
    \x11.hbb.ReadAllFilesH\0R\x08allFilesB\0\x123\n\x06cancel\x18\x08\x20\
    \x01(\x0b2\x17.hbb.FileTransferCancelH\0R\x06cancelB\0\x12J\n\x0csend_co\
    nfirm\x18\t\x20\x01(\x0b2#.hbb.FileTransferSendConfirmRequestH\0R\x0bsen\
    dConfirmB\0B\t\n\x05union\x12\0:\0\"(\n\x12FileTransferCancel\x12\x10\n\
    \x02id\x18\x01\x20\x01(\x05R\x02idB\0:\0\"\x8d\x02\n\x0cFileResponse\x12\
    (\n\x03dir\x18\x01\x20\x01(\x0b2\x12.hbb.FileDirectoryH\0R\x03dirB\0\x12\
    0\n\x05block\x18\x02\x20\x01(\x0b2\x16.hbb.FileTransferBlockH\0R\x05bloc\
    kB\0\x120\n\x05error\x18\x03\x20\x01(\x0b2\x16.hbb.FileTransferErrorH\0R\
    \x05errorB\0\x12-\n\x04done\x18\x04\x20\x01(\x0b2\x15.hbb.FileTransferDo\
    neH\0R\x04doneB\0\x123\n\x06digest\x18\x05\x20\x01(\x0b2\x17.hbb.FileTra\
    nsferDigestH\0R\x06digestB\0B\t\n\x05union\x12\0:\0\"\xaa\x01\n\x12FileT\
    ransferDigest\x12\x10\n\x02id\x18\x01\x20\x01(\x05R\x02idB\0\x12\x1b\n\
    \x08file_num\x18\x02\x20\x01(\x11R\x07fileNumB\0\x12%\n\rlast_modified\
    \x18\x03\x20\x01(\x04R\x0clastModifiedB\0\x12\x1d\n\tfile_size\x18\x04\
    \x20\x01(\x04R\x08fileSizeB\0\x12\x1d\n\tis_upload\x18\x05\x20\x01(\x08R\
    \x08isUploadB\0:\0\"\x95\x01\n\x11FileTransferBlock\x12\x10\n\x02id\x18\
    \x01\x20\x01(\x05R\x02idB\0\x12\x1b\n\x08file_num\x18\x02\x20\x01(\x11R\
    \x07fileNumB\0\x12\x14\n\x04data\x18\x03\x20\x01(\x0cR\x04dataB\0\x12\
    \x20\n\ncompressed\x18\x04\x20\x01(\x08R\ncompressedB\0\x12\x17\n\x06blk\
    _id\x18\x05\x20\x01(\rR\x05blkIdB\0:\0\"\\\n\x11FileTransferError\x12\
    \x10\n\x02id\x18\x01\x20\x01(\x05R\x02idB\0\x12\x16\n\x05error\x18\x02\
    \x20\x01(\tR\x05errorB\0\x12\x1b\n\x08file_num\x18\x03\x20\x01(\x11R\x07\
    fileNumB\0:\0\"\x89\x01\n\x17FileTransferSendRequest\x12\x10\n\x02id\x18\
    \x01\x20\x01(\x05R\x02idB\0\x12\x14\n\x04path\x18\x02\x20\x01(\tR\x04pat\
    hB\0\x12'\n\x0einclude_hidden\x18\x03\x20\x01(\x08R\rincludeHiddenB\0\
    \x12\x1b\n\x08file_num\x18\x04\x20\x01(\x05R\x07fileNumB\0:\0\"\x97\x01\
    \n\x1eFileTransferSendConfirmRequest\x12\x10\n\x02id\x18\x01\x20\x01(\
    \x05R\x02idB\0\x12\x1b\n\x08file_num\x18\x02\x20\x01(\x11R\x07fileNumB\0\
    \x12\x16\n\x04skip\x18\x03\x20\x01(\x08H\0R\x04skipB\0\x12!\n\noffset_bl\
    k\x18\x04\x20\x01(\rH\0R\toffsetBlkB\0B\t\n\x05union\x12\0:\0\"C\n\x10Fi\
    leTransferDone\x12\x10\n\x02id\x18\x01\x20\x01(\x05R\x02idB\0\x12\x1b\n\
    \x08file_num\x18\x02\x20\x01(\x11R\x07fileNumB\0:\0\"\x8b\x01\n\x1aFileT\
    ransferReceiveRequest\x12\x10\n\x02id\x18\x01\x20\x01(\x05R\x02idB\0\x12\
    \x14\n\x04path\x18\x02\x20\x01(\tR\x04pathB\0\x12&\n\x05files\x18\x03\
    \x20\x03(\x0b2\x0e.hbb.FileEntryR\x05filesB\0\x12\x1b\n\x08file_num\x18\
    \x04\x20\x01(\x05R\x07fileNumB\0:\0\"Y\n\rFileRemoveDir\x12\x10\n\x02id\
    \x18\x01\x20\x01(\x05R\x02idB\0\x12\x14\n\x04path\x18\x02\x20\x01(\tR\
    ...
    \tR\x04pathB\0:\0\"2\n\x13CliprdrMonitorReady\x12\x19\n\x07conn_id\x18\
    \x01\x20\x01(\x05R\x06connIdB\0:\0\"X\n\rCliprdrFormat\x12\x19\n\x07conn\
    _id\x18\x01\x20\x01(\x05R\x06connIdB\0\x12\x10\n\x02id\x18\x02\x20\x01(\
    \x05R\x02idB\0\x12\x18\n\x06format\x18\x03\x20\x01(\tR\x06formatB\0:\0\"\
    f\n\x17CliprdrServerFormatList\x12\x19\n\x07conn_id\x18\x01\x20\x01(\x05\
    R\x06connIdB\0\x12.\n\x07formats\x18\x02\x20\x03(\x0b2\x12.hbb.CliprdrFo\
    rmatR\x07formatsB\0:\0\"]\n\x1fCliprdrServerFormatListResponse\x12\x19\n\
    \x07conn_id\x18\x01\x20\x01(\x05R\x06connIdB\0\x12\x1d\n\tmsg_flags\x18\
    \x02\x20\x01(\x05R\x08msgFlagsB\0:\0\"o\n\x1eCliprdrServerFormatDataRequ\
    est\x12\x19\n\x07conn_id\x18\x01\x20\x01(\x05R\x06connIdB\0\x120\n\x13re\
    quested_format_id\x18\x02\x20\x01(\x05R\x11requestedFormatIdB\0:\0\"\x80\
    \x01\n\x1fCliprdrServerFormatDataResponse\x12\x19\n\x07conn_id\x18\x01\
    \x20\x01(\x05R\x06connIdB\0\x12\x1d\n\tmsg_flags\x18\x02\x20\x01(\x05R\
    \x08msgFlagsB\0\x12!\n\x0bformat_data\x18\x03\x20\x01(\x0cR\nformatDataB\
    \0:\0\"\xde\x02\n\x1aCliprdrFileContentsRequest\x12\x19\n\x07conn_id\x18\
    \x01\x20\x01(\x05R\x06connIdB\0\x12\x1d\n\tstream_id\x18\x02\x20\x01(\
    \x05R\x08streamIdB\0\x12\x1f\n\nlist_index\x18\x03\x20\x01(\x05R\tlistIn\
    dexB\0\x12\x1b\n\x08dw_flags\x18\x04\x20\x01(\x05R\x07dwFlagsB\0\x12&\n\
    \x0en_position_low\x18\x05\x20\x01(\x05R\x0cnPositionLowB\0\x12(\n\x0fn_\
    position_high\x18\x06\x20\x01(\x05R\rnPositionHighB\0\x12#\n\x0ccb_reque\
    sted\x18\x07\x20\x01(\x05R\x0bcbRequestedB\0\x12+\n\x11have_clip_data_id\
    \x18\x08\x20\x01(\x08R\x0ehaveClipDataIdB\0\x12\"\n\x0cclip_data_id\x18\
    \t\x20\x01(\x05R\nclipDataIdB\0:\0\"\xa1\x01\n\x1bCliprdrFileContentsRes\
    ponse\x12\x19\n\x07conn_id\x18\x01\x20\x01(\x05R\x06connIdB\0\x12\x1d\n\
    \tmsg_flags\x18\x03\x20\x01(\x05R\x08msgFlagsB\0\x12\x1d\n\tstream_id\
    \x18\x04\x20\x01(\x05R\x08streamIdB\0\x12'\n\x0erequested_data\x18\x05\
    \x20\x01(\x0cR\rrequestedDataB\0:\0\"\xd3\x04\n\x07Cliprdr\x122\n\x05rea\
    dy\x18\x01\x20\x01(\x0b2\x18.hbb.CliprdrMonitorReadyH\0R\x05readyB\0\x12\
    A\n\x0bformat_list\x18\x02\x20\x01(\x0b2\x1c.hbb.CliprdrServerFormatList\
    H\0R\nformatListB\0\x12Z\n\x14format_list_response\x18\x03\x20\x01(\x0b2\
    $.hbb.CliprdrServerFormatListResponseH\0R\x12formatListResponseB\0\x12W\
    \n\x13format_data_request\x18\x04\x20\x01(\x0b2#.hbb.CliprdrServerFormat\
    DataRequestH\0R\x11formatDataRequestB\0\x12Z\n\x14format_data_response\
    \x18\x05\x20\x01(\x0b2$.hbb.CliprdrServerFormatDataResponseH\0R\x12forma\
    tDataResponseB\0\x12W\n\x15file_contents_request\x18\x06\x20\x01(\x0b2\
    \x1f.hbb.CliprdrFileContentsRequestH\0R\x13fileContentsRequestB\0\x12Z\n\
    \x16file_contents_response\x18\x07\x20\x01(\x0b2\x20.hbb.CliprdrFileCont\
    entsResponseH\0R\x14fileContentsResponseB\0B\t\n\x05union\x12\0:\0\"\x7f\
    \n\rSwitchDisplay\x12\x1a\n\x07display\x18\x01\x20\x01(\x05R\x07displayB\
    \0\x12\x0e\n\x01x\x18\x02\x20\x01(\x11R\x01xB\0\x12\x0e\n\x01y\x18\x03\
    \x20\x01(\x11R\x01yB\0\x12\x16\n\x05width\x18\x04\x20\x01(\x05R\x05width\
    B\0\x12\x18\n\x06height\x18\x05\x20\x01(\x05R\x06heightB\0:\0\"\xba\x01\
    \n\x0ePermissionInfo\x12@\n\npermission\x18\x01\x20\x01(\x0e2\x1e.hbb.Pe\
    rmissionInfo.PermissionR\npermissionB\0\x12\x1a\n\x07enabled\x18\x02\x20\
    \x01(\x08R\x07enabledB\0\"H\n\nPermission\x12\x0e\n\x08Keyboard\x10\0\
    \x1a\0\x12\x0f\n\tClipboard\x10\x02\x1a\0\x12\x0b\n\x05Audio\x10\x03\x1a\
    \0\x12\n\n\x04File\x10\x04\x1a\0\x1a\0:\0\"\xc4\x05\n\rOptionMessage\x12\
    8\n\rimage_quality\x18\x01\x20\x01(\x0e2\x11.hbb.ImageQualityR\x0cimageQ\
    ualityB\0\x12T\n\x16lock_after_session_end\x18\x02\x20\x01(\x0e2\x1d.hbb\
    .OptionMessage.BoolOptionR\x13lockAfterSessionEndB\0\x12M\n\x12show_remo\
    te_cursor\x18\x03\x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolOptionR\x10sho\
    wRemoteCursorB\0\x12B\n\x0cprivacy_mode\x18\x04\x20\x01(\x0e2\x1d.hbb.Op\
    tionMessage.BoolOptionR\x0bprivacyModeB\0\x12@\n\x0bblock_input\x18\x05\
    \x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolOptionR\nblockInputB\0\x122\n\
    \x14custom_image_quality\x18\x06\x20\x01(\x05R\x12customImageQualityB\0\
    \x12D\n\rdisable_audio\x18\x07\x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolO\
    ptionR\x0cdisableAudioB\0\x12L\n\x11disable_clipboard\x18\x08\x20\x01(\
    \x0e2\x1d.hbb.OptionMessage.BoolOptionR\x10disableClipboardB\0\x12Q\n\
    \x14enable_file_transfer\x18\t\x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolO\
    ptionR\x12enableFileTransferB\0\"1\n\nBoolOption\x12\x0c\n\x06NotSet\x10\
    \0\x1a\0\x12\x08\n\x02No\x10\x01\x1a\0\x12\t\n\x03Yes\x10\x02\x1a\0\x1a\
    \0:\0\"F\n\tTestDelay\x12\x14\n\x04time\x18\x01\x20\x01(\x03R\x04timeB\0\
    \x12!\n\x0bfrom_client\x18\x02\x20\x01(\x08R\nfromClientB\0:\0\"e\n\tPub\
    licKey\x12+\n\x10asymmetric_value\x18\x01\x20\x01(\x0cR\x0fasymmetricVal\
    ueB\0\x12)\n\x0fsymmetric_value\x18\x02\x20\x01(\x0cR\x0esymmetricValueB\
    \0:\0\"\x1e\n\x08SignedId\x12\x10\n\x02id\x18\x01\x20\x01(\x0cR\x02idB\0\
    :\0\"P\n\x0bAudioFormat\x12!\n\x0bsample_rate\x18\x01\x20\x01(\rR\nsampl\
    eRateB\0\x12\x1c\n\x08channels\x18\x02\x20\x01(\rR\x08channelsB\0:\0\"D\
    \n\nAudioFrame\x12\x14\n\x04data\x18\x01\x20\x01(\x0cR\x04dataB\0\x12\
    \x1e\n\ttimestamp\x18\x02\x20\x01(\x03R\ttimestampB\0:\0\"\xa8\x04\n\x10\
    BackNotification\x12X\n\x12privacy_mode_state\x18\x01\x20\x01(\x0e2&.hbb\
    .BackNotification.PrivacyModeStateH\0R\x10privacyModeStateB\0\x12U\n\x11\
    block_input_state\x18\x02\x20\x01(\x0e2%.hbb.BackNotification.BlockInput\
    StateH\0R\x0fblockInputStateB\0\"o\n\x0fBlockInputState\x12\x12\n\x0cSta\
    teUnknown\x10\x01\x1a\0\x12\x11\n\x0bOnSucceeded\x10\x02\x1a\0\x12\x0e\n\
    \x08OnFailed\x10\x03\x1a\0\x12\x12\n\x0cOffSucceeded\x10\x04\x1a\0\x12\
    \x0f\n\tOffFailed\x10\x05\x1a\0\x1a\0\"\xe4\x01\n\x10PrivacyModeState\
    \x12\x12\n\x0cStateUnknown\x10\x01\x1a\0\x12\x0f\n\tOnByOther\x10\x02\
    \x1a\0\x12\x12\n\x0cNotSupported\x10\x03\x1a\0\x12\x11\n\x0bOnSucceeded\
    \x10\x04\x1a\0\x12\x14\n\x0eOnFailedDenied\x10\x05\x1a\0\x12\x14\n\x0eOn\
    FailedPlugin\x10\x06\x1a\0\x12\x0e\n\x08OnFailed\x10\x07\x1a\0\x12\x12\n\
    \x0cOffSucceeded\x10\x08\x1a\0\x12\x0f\n\tOffByPeer\x10\t\x1a\0\x12\x0f\
    \n\tOffFailed\x10\n\x1a\0\x12\x10\n\nOffUnknown\x10\x0b\x1a\0\x1a\0B\t\n\
    \x05union\x12\0:\0\"\xf9\x03\n\x04Misc\x127\n\x0cchat_message\x18\x04\
    ...
    \x01(\x08H\0R\x0crefreshVideoB\0\x12)\n\x0evideo_received\x18\x0c\x20\
    \x01(\x08H\0R\rvideoReceivedB\0\x12F\n\x11back_notification\x18\r\x20\
    \x01(\x0b2\x15.hbb.BackNotificationH\0R\x10backNotificationB\0B\t\n\x05u\
    nion\x12\0:\0\"\xa8\x07\n\x07Message\x12.\n\tsigned_id\x18\x03\x20\x01(\
    \x0b2\r.hbb.SignedIdH\0R\x08signedIdB\0\x121\n\npublic_key\x18\x04\x20\
    \x01(\x0b2\x0e.hbb.PublicKeyH\0R\tpublicKeyB\0\x121\n\ntest_delay\x18\
    \x05\x20\x01(\x0b2\x0e.hbb.TestDelayH\0R\ttestDelayB\0\x124\n\x0bvideo_f\
    rame\x18\x06\x20\x01(\x0b2\x0f.hbb.VideoFrameH\0R\nvideoFrameB\0\x12:\n\
    \rlogin_request\x18\x07\x20\x01(\x0b2\x11.hbb.LoginRequestH\0R\x0cloginR\
    equestB\0\x12=\n\x0elogin_response\x18\x08\x20\x01(\x0b2\x12.hbb.LoginRe\
    sponseH\0R\rloginResponseB\0\x12!\n\x04hash\x18\t\x20\x01(\x0b2\t.hbb.Ha\
    shH\0R\x04hashB\0\x124\n\x0bmouse_event\x18\n\x20\x01(\x0b2\x0f.hbb.Mous\
    ...
    \0R\x04miscB\0\x12*\n\x07cliprdr\x18\x14\x20\x01(\x0b2\x0c.hbb.CliprdrH\
    \0R\x07cliprdrB\0B\t\n\x05union\x12\0:\0*\xb9\x08\n\nControlKey\x12\r\n\
    \x07Unknown\x10\0\x1a\0\x12\t\n\x03Alt\x10\x01\x1a\0\x12\x0f\n\tBackspac\
    e\x10\x02\x1a\0\x12\x0e\n\x08CapsLock\x10\x03\x1a\0\x12\r\n\x07Control\
    ...
    FileLink\x10\x05\x1a\0\x1a\0*E\n\x0cImageQuality\x12\x0c\n\x06NotSet\x10\
    \0\x1a\0\x12\t\n\x03Low\x10\x02\x1a\0\x12\x0e\n\x08Balanced\x10\x03\x1a\
    \0\x12\n\n\x04Best\x10\x04\x1a\0\x1a\0B\0b\x06proto3\
";
